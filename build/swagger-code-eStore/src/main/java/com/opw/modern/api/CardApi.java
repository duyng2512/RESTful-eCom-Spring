...
public interface CardApi {
     ...
     * @return For successful fetch. (status code 200)
     */
    @ApiOperation(value = "Creates a new user addresses", nickname = "registerCard", notes = "Creates a new user addresses. Does nothing if address already exists.", response = Card.class, tags={ "card", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "For successful fetch.", response = Card.class) })
    @RequestMapping(value = "/api/v1/cards",
        produces = { "application/xml", "application/json" }, 
