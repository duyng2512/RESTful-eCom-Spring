...
public interface CustomerApi {
     ...
     */
    @ApiOperation(value = "Returns all customer's addresses", nickname = "getAddressesByCustomerId", notes = "Returns all customer's addresses based on given customer ID", response = Address.class, responseContainer = "List", tags={ "customer", })
    @ApiResponses(value = { 
    ...
    default ResponseEntity<List<Address>> getAddressesByCustomerId(@ApiParam(value = "Customer Identifier",required=true) @PathVariable("id") String id) {
     ...
     * @return For successful fetch. (status code 200)
     */
    @ApiOperation(value = "Returns all customer's cards", nickname = "getCardByCustomerId", notes = "Returns all customer's cards based on given customer ID", response = Card.class, tags={ "customer", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "For successful fetch.", response = Card.class) })
    @RequestMapping(value = "/api/v1/customers/{id}/cards",
        produces = { "application/xml", "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<Card> getCardByCustomerId(@ApiParam(value = "Customer Identifier",required=true) @PathVariable("id") String id) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
